<template>
    <div class="flex flex-col flex-1 items-center">
        <div class="flex flex-col items-center text-white py-12">
            ...
            <p class="text-8xl mb-8">{{ Math.round(weatherData.current.temp)}}°C
            </p>
    ...
    <div class="max-w-screen-md w-full py-12">
        <div class="mx-8 text-white overflow-x-scroll">
...
const getWeatherData = async() => {
    try{
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&appid=7efa332cf48aeb9d2d391a51027f1a71&units=metric`
        );
